  ...
  return (
    <div className={styles.background}>
      ...
      <div className={styles.frame}>
        <div className={styles.windowTitle}><span></span>info<span style={{position: 'relative', right: '4px'}}  ><CloseIcon /></span></div>
        <div className={styles.terminal}>
          ...
          <p className={styles.command}>>> Vincent.education.expectedGraduation</p>
          <p className={styles.output}>'May 2022'</p>
          <p className={styles.command}>>> Vincent.workExperience.current</p>
          <p className={styles.outputS}>company: 'University of Nevada, Reno'</p>
          ...
          <p className={styles.command} style={{marginTop: '30px'}}>>> Vincent.resume.link</p>  
          <p className={styles.output}>'<a href="/pdf/CV-VincentPham.pdf" className={styles.link}>CV-VincentPham.pdf</a>'</p>
